...
getContributingPointsInfoForNitrateCells <- function(nitrateCells, timeFrameOfInterest, allModpathFlowlines, allModpathStartingPoints) {
  #Troubleshooting
  nitrateCells <- head(nitrateCells, 3200)
  dotCount <- 0
...
getNitrateCellsMLR <- function(nitrateCells) {
  regression <- lm(nitrateCells$MEAN_Nitrate_mg_L_0 ~ nitrateCells$Land_Use_1)
  summary(regression)
}
...
mainNitrateCorrelator <- function(){
  ...
  plot(nitrateCells$Land_Use_1, nitrateCells$MEAN_Nitrate_mg_L_0)
